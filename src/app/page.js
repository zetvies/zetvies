...
c19.5-0.1,39-0.1,58.6-0.2c-0.1-17.8-0.1-35.6-0.2-53.5C57.9,17.4,49.2,5,37.2,1.2z"
	...
	c-12-1.6-29.1-4.3-49.6-9C786,0,770,0,754,0z"
      ...
      <div
        ...
        } absolute top-0 left-0 z-[1000] snap-always snap-start w-full h-screen flex flex-col justify-end md:justify-center pb-[25svh] md:pb-0 items-center overflow-hidden bg-[#c7d783]`}
      >
        <button
